    ...
    <>
      <div className="bento_container">
        ...
        <div id="social_container" className="section_container">
            ...
            <Social color='black' link='https://docs.google.com/document/u/1/d/e/2PACX-1vSctYJIbMy6JDOova-LZsw7Wg966rvTNg9xNkLWpJkhh8fiB-psKHt-IbFTKGUtGk7BzVVpNS-GcD2N/pub' text='Download' name='Resume' icon={IoIosDocument} />
